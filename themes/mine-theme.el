;;; mine-theme.el --- My personal theme ;-*- eval: (progn (rainbow-mode) (fontify-face-mode) (add-hook 'after-save-hook (lambda () (my/change-theme (intern-soft (replace-regexp-in-string "-theme\.el" "" (buffer-name))))) nil t)); lexical-binding: t; -*-
;;; Commentary:
;;
;;; Code:
...
(mine-add-faces doom-modeline
  (bar :inherit default)
  (buffer-file :background nil :foreground ,red :weight bold)
  ...
  (buffer-modified :foreground ,red :weight bold)
  (buffer-path :background nil :foreground ,green :weight bold)
  ...
  (inactive-bar :background nil :foreground ,gray)
  (info :foreground ,red :weight bold)
  (panel :inherit default)
  (project-dir :foreground ,gray :background nil :weight ultra-bold)
...
(mine-add-faces org
  ...
  (block-end-line :background nil :foreground ,gray :extend t)
