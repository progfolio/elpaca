...
(let* ((font-sizes '(1.10 1.15 1.25 1.5))
       ...
       (faces '(;; basics
                ...
                ;;syntax
                (font-lock-function-name-face :weight bold :foreground ,blue)
                (font-lock-type-face :foreground ,green)
                (font-lock-keyword-face :weight bold :foreground ,red)
                (font-lock-builtin-face :weight normal :foreground ,gray)
                (font-lock-comment-face :foreground ,blue)
                (font-lock-constant-face :foreground ,blue :weight bold)
                (font-lock-string-face :foreground ,red :weight normal)
                (font-lock-variable-name-face :foreground ,blue :weight normal)
                ...
                ;;###org
                ;;(org-agenda-column-dateline  :foreground ,gray :weight bold)
                (org-agenda-dimmed-todo-face :foreground ,gray :weight bold)
                (org-agenda-current-time :foreground ,blue :weight bold)
                (org-agenda-done  :foreground ,gray :weight bold)
                (org-agenda-date-today  :foreground ,yellow :inherit org-agenda-date :weight bold)
                ...
                (org-column :weight bold :foreground ,green :background ,dark-purple )
                ...
                (org-scheduled-previously  :foreground ,red :weight bold)
                (org-scheduled :foreground ,blue :weight bold)
                ...
                (org-verbatim  :weight bold :foreground ,blue)
                (org-warning :foreground ,blue :weight bold )
                ;;reb
