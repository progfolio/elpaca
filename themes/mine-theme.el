...
(mine-add-faces nil
  ...
  (default :background ,dark-purple :foreground ,yellow :weight normal :height 130 :distant-foreground ,dark-purple)
...
(mine-add-faces org
  ...
  (block :background ,purple :foreground ,green :weight normal  :extend t)
  ...
  (column :weight bold :foreground ,green :background ,purple )
