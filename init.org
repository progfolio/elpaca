      ...
      (let ((buffer (get-buffer-create "*parcel-bootstrap*")))
        (condition-case-unless-debug err
            (progn
              ...
              ;;@FIX: this breaks our defstruct somehow?
...
(parcel--bootstrap)
(add-hook 'after-init-hook #'parcel-queue-empty)
(add-hook 'parcel-after-init-hook
...
** TODO lilypond (fork using https protocol, stuck on auth, not registered as blocked, either.)
...
#+end_quote
#+begin_src emacs-lisp :lexical t
(parcel-use-package (mu4e-alert :host github :remotes (("fork" :repo "progfolio/mu4e-alert") "origin"))
  :defer 20
  :after (org)
  :config
