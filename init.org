...
(when-let ((parcel-repo (expand-file-name "repos/parcel/" parcel-directory))
           (parcel-url  "git@github.com:progfolio/parcel.git")
...
(parcel-use-package (pdf-tools :post-build ((condition-case err
                                                (let* ((repo-dir default-directory)
                                                       ...
                                                       (epdfinfo (expand-file-name "./lisp/epdfinfo" repo-dir)))
                                                  (require 'pdf-tools)
                                                  ...
                                                  (copy-file epdfinfo (file-name-as-directory build-dir))
                                                  (delete-file epdfinfo))
