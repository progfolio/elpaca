...
(require 'elp)
(with-eval-after-load 'elpaca
  (elp-instrument-package "elpaca"))
(add-hook 'elpaca-after-init-hook
          (lambda () (elp-results) (elp-restore-package 'elpaca)))
#+end_src
...
(when-let ((elpaca-repo (expand-file-name "repos/elpaca.progfolio.github/" elpaca-directory))
           (elpaca-url  "git@github.com:progfolio/elpaca.git")
...
#+begin_src emacs-lisp :lexical t
(setq +elpaca-installed (file-exists-p (expand-file-name "repos" elpaca-directory)))
(add-hook 'emacs-startup-hook (lambda () (unless +elpaca-installed (elpaca-status))))
#+end_src
...
#+begin_src emacs-lisp :lexical t
(elpaca-use-package (pdf-tools :post-build ((condition-case err
                                                (let* ((repo-dir default-directory)
                                                       (build-dir (expand-file-name "builds/pdf-tools" elpaca-directory))
...
(elpaca-use-package (speedo :host github :repo "progfolio/speedo"
  ...
  :custom
  (speedo-directory "~/.emacs.d/elpaca/repos/speedo.progfolio.github/test/")
