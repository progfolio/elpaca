...
(parcel-use-package projectile
  ...
  (projectile-mode))
#+end_src
** TODO pdf-tools (:post-build fails)
#+begin_quote
...
#+begin_src emacs-lisp :lexical t
(parcel-use-package (pdf-tools :post-build ((require 'pdf-tools)
                                            (condition-case err
                                                (progn
                                                      ...
                                                      (while (get-buffer-process (current-buffer))
                                                        ...
                                                        (when (buffer-modified-p)
                                                          (let ((s (substring-no-properties (buffer-string))))
                                                            (message "%S" s)
                                                            (setq seen (concat seen (buffer-string)))))))))
...
#+end_quote
#+begin_src emacs-lisp :lexical t
(parcel-use-package (vterm :post-build ((setq vterm-always-compile-module t)
                                        (require 'vterm)
