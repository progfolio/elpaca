...
(use-package lilypond-mode
  :straight (lilypond-mode :host gitlab :repo "lilypond/lilypond" :files ("elisp/*.el"))
  :commands (LilyPond-mode)
  :general
  (global-leader
    :major-modes '(LilyPond-mode t)
    :keymaps     '(LilyPond-mode-map)
    "m"  '(LilyPond-command-formatmidi :which-key "format midi")
    "l"  '(LilyPond-command-lilypond :which-key "compile w lilypond")
    "p"  '(LilyPond-command-current-midi :which-key "play midi"))
  :init
