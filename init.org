...
(use-package accord
  ...
  (defun accord-setup ()
    (when accord-mode
      ...
      (flyspell-mode)
      (visual-line-mode)
      (let ((accord-mode-hook nil))
        (accord-mode))))
  (global-definer
    :major-modes '(markdown-mode t)
    :keymaps 'accord-mode-map
    "m" '(:ignore t :which-key "accord-mode")
    "me" nil
    "me" '(accord-edit-message :which-key "accord-edit-message")
    "md" 'accord-delete-message
    "ms" 'accord-send-message
    "m/" 'accord-select-channel
    "m;" 'accord-last-channel)
