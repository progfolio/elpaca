...
(defun my/gc-after-focus-change ()
  "Run GC when frame is unfocused."
  (run-with-idle-timer
   5 nil
  ...
  (run-with-idle-timer
   ...
   (lambda ()
     ...
     (when (boundp 'after-focus-change-function)
       (add-function :after after-focus-change-function #'my/gc-after-focus-change)))))
...
(use-package shackle
  ...
  :hook ((flycheck-mode global-flycheck-mode flymake-mode accord-mode) . shackle-mode))
#+end_src
** shr-color
#+begin_src emacs-lisp
