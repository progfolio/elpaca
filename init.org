...
:END:
#+begin_quote
This is a collection of Evil bindings for the parts of Emacs that Evil does not cover properly by default,This is a collection of Evil bindings for the parts of Emacs that Evil does not cover properly by default.
...
(use-package org-make-toc
  :straight '(:fork (:repo "progfolio/org-make-toc"))
