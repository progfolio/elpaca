...
| elpaca-ui-visit-build       | vb              | Visit the current package's build directory via =dired=                            | no            |
| elpaca-ui-mark-rebuild      | vr              | Mark the current package for rebuilding                                          | yes           |
